        ...
        <div class="row mt-5 ">
          ...
          <div class="col-12 col-sm-6 py-2 wow fadeInRight" data-wow-delay="300ms">
            <select name="doctor" id="departement" class="custom-select">
              ...
              <option value="{{ $doctors->name }}">{{ $doctors->name }}  ({{ $doctors->speciality }} doctor)</option>
              @endforeach
            </select>
          </div>
          ...
          <div class="col-12 py-2 wow fadeInUp" data-wow-delay="300ms">
            <textarea name="message" required id="message" class="form-control" rows="6" placeholder="Enter message.."></textarea>
          </div>
        </div>
